...
import { User, Bell, Database, Download, Trash2, Save } from "lucide-react";
import {
  Card,
  CardContent,
  CardDescription,
...
export default function SettingsPage() {
  ...
  const handleClearData = async () => {
    ...
    toast({
      ...
      description:
        "Alle Daten wurden gelöscht. Bitte starten Sie die Seed-Funktion.",
    });
  };
  ...
  const handleReseedData = async () => {
    ...
    if (result.success) {
      toast({
        title: "Datenbank befüllt",
        description: "Die Demo-Daten wurden erfolgreich eingefügt.",
      });
    } else {
      toast({
        title: "Hinweis",
    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-slate-500 mt-1">
          Konto und Systemeinstellungen verwalten
        </p>
      </div>
        ...
        <TabsContent value="notifications">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Konfigurieren Sie, welche Benachrichtigungen Sie erhalten
                möchten
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
        ...
        <TabsContent value="data">
          <div className="space-y-6">
            ...
            <Card>
              ...
              <CardContent>
                <Button onClick={handleReseedData} variant="outline">
                  <Database className="h-4 w-4 mr-2" />
                  Demo-Daten laden
                </Button>
              </CardContent>
            ...
            <Card className="border-red-200">
              <CardHeader>
                ...
                <CardDescription>
                  Vorsicht: Diese Aktionen können nicht rückgängig gemacht
                  werden
                </CardDescription>
              </CardHeader>
              <CardContent>
                <AlertDialog>
                  ...
                  <AlertDialogContent>
                    <AlertDialogHeader>
                      ...
                      <AlertDialogDescription>
                        Diese Aktion löscht alle Daten unwiderruflich. Sie
                        werden ausgeloggt und müssen die Demo-Daten neu laden.
                      </AlertDialogDescription>
                    </AlertDialogHeader>
                    <AlertDialogFooter>
              ...
              <CardContent>
                <div className="grid gap-4 text-sm">
                  ...
                  <div className="flex justify-between py-2 border-b">
                    ...
                    <span className="font-medium">Convex (Cloud)</span>
                  </div>
                  <div className="flex justify-between py-2">
                    <span className="text-slate-500">Framework</span>
                    <span className="font-medium">Next.js + Convex</span>
                  </div>
                </div>
              </CardContent>
            </Card>
